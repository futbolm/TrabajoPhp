        ...
        <div class="row justify-content-center" >
            ...
            <form class="col-md-6" method="post">
                ...
                <div class="form-group">
                    ...
                    id="fecha" name="peli_fechaEstreno"
                ...
                <div class="form-group">
                    ...
                    id="restricciones" name="peli_restricciones"
            ...
            <?php
                if(isset($_POST['editar'])){
                    ...
                    $queryUpdate="UPDATE peliculas set peli_nombre='{$peli_nombre}',peli_genero='{$peli_genero}',peli_fechaEstreno='{$peli_fechaEstreno}',peli_restricciones='{$peli_restricciones}',peli_img='{$peli_img}',
